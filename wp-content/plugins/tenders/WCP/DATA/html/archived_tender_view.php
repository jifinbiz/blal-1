...
<div class="container  investor-page-acf " style="padding-top:20px;">
    <div class="col-sm-12">
     ...
     <!-- <div class="col-sm-6" style="margin:15px 0 20px;">
            ...
            <select name="location"   id="location_old" style="color:#000000;font-weight:bold;height:30px;width:200px;display: inline-block;">
        ...
        <div class="col-sm-12" style="margin:10px 0;">
            <h4 style="text-align:right;"><a href="http://crm-doctor.com/blal/active-tender/" >BACK TO ACTIVE TENDERS</a></h3>
        </div>
...
<script>
  ...
  function reload_table(loc=null) {
        ...
        $('#corr-table').dataTable({
                    ...
                    "ajax": {
                        ...
                        data: {"action": "tender_get_old_data_frontend","location":loc}
  ...
  jQuery("#location_old").change(function(){
